...
public class UserDataNetwork implements UserData {
    ...
    public void getMe() {
        ...
        call.enqueue(new Callback<UserDetailInfo>() {
            @Override
            public void onResponse(Call<UserDetailInfo> call,
    ...
    @Override
    public void blockUser(String token, String loginName) {
        ...
        call.enqueue(new Callback<UserBlock>() {
            ...
            @Override
            public void onFailure(Call<UserBlock> call, Throwable t) {
                Log.e(TAG, t.getMessage());
                EventBus.getDefault().post(new UserBlockEvent(null));
            }
        });
    ...
    @Override
    public void unBlockUser(String token, String loginName) {
        ...
        call.enqueue(new Callback<UserUnBlock>() {
            ...
            @Override
            public void onFailure(Call<UserUnBlock> call, Throwable t) {
                Log.e(TAG, t.getMessage());
                EventBus.getDefault().post(new UserUnBlockEvent(null));
            }
        });
    ...
    @Override
    public void followUser(String token, String loginName) {
    ...
    @Override
    public void unFollowUser(String token, String loginName) {
    ...
    @Override
    public void favoriteTopic(String token, int id) {

    }

    @Override
    public void unFavoriteTopic(String token, int id) {

    }

    @Override
    public void followTopic(String token, int id) {

    }

    @Override
    public void unFollowTopic(String token, int id) {
